...
class SpatialAttention_SIAM(nn.Module):
    def __init__(self, kernel_size=7):
        super(SpatialAttention_SIAM, self).__init__()
...
class CSIAM(nn.Module):
    def __init__(self, channel, ratio=8, kernel_size=7):
        ...
        self.spatialattention = SpatialAttention_SIAM(kernel_size=kernel_size)
